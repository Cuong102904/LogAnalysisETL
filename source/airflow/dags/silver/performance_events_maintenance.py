...
def _maintenance_arguments() -> list[str]:
    ...
    arguments = [
        ...
        table_path,
        "--app-name",
        "silver_performance_events_maintenance",
    ]
...
with DAG(
    dag_id="silver_maintenance_performance_events",
    description="Scheduled OPTIMIZE and VACUUM for Silver Delta table: performance_events",

...
def _maintenance_arguments() -> list[str]:
    ...
    table_path = f"{base_path}/pdf_interactions"
    
    arguments = [
        "--table-path",
        table_path,
        "--app-name",
        f"silver_pdf_interactions_maintenance",
    ]
...
with DAG(
    dag_id=f"silver_maintenance_pdf_interactions",
    description=f"Scheduled OPTIMIZE and VACUUM for Silver Delta table: pdf_interactions",

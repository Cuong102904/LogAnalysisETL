...
def _maintenance_arguments() -> list[str]:
    ...
    arguments = [
        ...
        table_path,
        "--app-name",
        f"silver_unknown_events_maintenance",
    ]
...
with DAG(
    dag_id=f"silver_maintenance_unknown_events",
    description=f"Scheduled OPTIMIZE and VACUUM for Silver Delta table: unknown_events",

...
def spark_task(
    ...
    conf = {
        ...
        "spark.executorEnv.PYTHONPATH": os.getenv(
            "SPARK_EXECUTOR_PYTHONPATH", "/opt/project/src:/opt/project"
        ),
    ...
    return SparkSubmitOperator(
        ...
        env_vars={
            "PYTHONPATH": os.getenv("PYTHONPATH", "/opt/airflow:/opt/project:/opt/project/src"),
            "SPARK_CONF_DIR": os.getenv(

    ...
    def from_env(cls) -> "SilverConfig":
        ...
        return cls(
            ...
            performance_path=required_env_str(
                "SILVER_PERFORMANCE_PATH", config, "storage", "performance_path"
            ),
            ...
            navigation_path=required_env_str(
                "SILVER_NAVIGATION_PATH", config, "storage", "navigation_path"
            ),
            ...
            exam_query_name=env_str(
                "SILVER_EXAM_QUERY_NAME",
                config,
                "streaming",
                "exam_query_name",
                default="silver_exam_attempts",
            ),
            ...
            navigation_query_name=env_str(
                "SILVER_NAVIGATION_QUERY_NAME",
                config,
                "streaming",
                "navigation_query_name",
                default="silver_navigation_events",
            ),
            pdf_query_name=env_str(
                "SILVER_PDF_QUERY_NAME",
                config,
                "streaming",
                "pdf_query_name",
                default="silver_pdf_interactions",
            ),
